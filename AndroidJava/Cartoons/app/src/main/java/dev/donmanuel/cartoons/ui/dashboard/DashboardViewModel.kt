...
import dev.donmanuel.cartoons.ui.dashboard.api.ApiClient
...
class DashboardViewModel : ViewModel() {
    ...
    fun fetchSimpsonsEpisodes() {
        _isLoading.value = true
        _error.value = null

        ApiClient.apiService.getSimpsonsEpisodes().enqueue(object : Callback<List<Simpsons>> {
            override fun onResponse(call: Call<List<Simpsons>>, response: Response<List<Simpsons>>) {
